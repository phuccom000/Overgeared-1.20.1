...
public class ForgingRecipeJEI implements Recipe<SimpleContainer> {
    ...
    public ForgingRecipeJEI(NonNullList<Ingredient> inputItems, int hammeringRequired, ItemStack output, ResourceLocation id) {
    ...
    public static class Type implements RecipeType<ForgingRecipeJEI> {
    ...
    public static class Serializer implements RecipeSerializer<ForgingRecipeJEI> {
        public static final Serializer INSTANCE = new Serializer();
        public static final ResourceLocation ID = ResourceLocation.tryBuild(OvergearedMod.MOD_ID, "forging");

        @Override
        public ForgingRecipeJEI fromJson(ResourceLocation pRecipeId, JsonObject pSerializedRecipe) {
            ...
            return new ForgingRecipeJEI(inputs, hammering, output, pRecipeId);
        }
        ...
        /*@Override
        public @Nullable ForgingRecipeJEI fromNetwork(ResourceLocation pRecipeId, FriendlyByteBuf pBuffer) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf pBuffer, ForgingRecipeJEI pRecipe) {
