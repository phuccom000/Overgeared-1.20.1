...
public class CastFurnaceMenu extends AbstractContainerMenu {

    private final Container container;
    private final ContainerData data;

    public CastFurnaceMenu(int id, Inventory playerInv, FriendlyByteBuf buf) {
        this(id, playerInv, (CastFurnaceBlockEntity) playerInv.player.level().getBlockEntity(buf.readBlockPos()), new SimpleContainerData(4));
    }


    public CastFurnaceMenu(int id, Inventory playerInv, CastFurnaceBlockEntity be, ContainerData data) {
        super(ModMenuTypes.CAST_FURNACE.get(), id);
        this.container = be;
        this.data = data;
        ...
        /* ---------- Furnace slots ---------- */
        // Input
        this.addSlot(new Slot(container, CastFurnaceBlockEntity.SLOT_INPUT, 56, 24) {
            @Override
        ...
        // Fuel
        this.addSlot(new Slot(container, CastFurnaceBlockEntity.SLOT_FUEL, 8, 53));
        ...
        // Cast
        this.addSlot(new Slot(container, CastFurnaceBlockEntity.SLOT_CAST, 56, 46));
