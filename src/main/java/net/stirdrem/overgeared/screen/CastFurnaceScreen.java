...
public class CastFurnaceScreen extends AbstractContainerScreen<CastFurnaceMenu> {

    private static final ResourceLocation TEXTURE =
            new ResourceLocation(OvergearedMod.MOD_ID, "textures/gui/cast_furnace.png");

    public CastFurnaceScreen(CastFurnaceMenu menu, Inventory inv, Component title) {
