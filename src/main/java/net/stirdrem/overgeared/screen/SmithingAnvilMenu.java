...
public class SmithingAnvilMenu extends RecipeBookMenu<Container> {
            ...
            this.resultSlot = new SlotItemHandler(iItemHandler, 10, 124, 35) {
                ...
                public void onTake(Player player, ItemStack stack) {
                    ...
                    NonNullList<ItemStack> remainders = player.level()
                            .getRecipeManager().getRemainingItemsFor(ModRecipeTypes.FORGING.get(),
                                    SmithingAnvilMenu.this.container, player.level());
                ...
                protected void checkTakeAchievements(ItemStack stack) {
                    if (this.removeCount > 0)
                        stack.onCraftedBy(SmithingAnvilMenu.this.player.level(), SmithingAnvilMenu.this.player,
                                this.removeCount);
    ...
    public @NotNull RecipeBookType getRecipeBookType() {
        return OvergearedMod.RECIPE_TYPE_FORGING;
    }
