package net.stirdrem.overgeared.worldgen;
...
public class ModConfiguredFeatures {
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> ROCK = registerKey("rock");
    ...
    public static ResourceKey<ConfiguredFeature<?, ?>> registerKey(String name) {
        return ResourceKey.create(Registries.CONFIGURED_FEATURE, ResourceLocation.tryBuild(OvergearedMod.MOD_ID, name));
    }
